 ...
 *
 * Provides international payment options through UddoktaPay's global payment processors.
 *
 * @since 1.0.0
 */
class InternationalGateway extends AbstractGateway {
	...
	protected function get_payment_data_meta_key() {
		return 'uddoktapay_international_payment_data';
	}
	...
	protected function get_default_title() {
		return __( 'International Payment', 'uddoktapay-gateway' );
	}
	...
	protected function get_default_description() {
		return __( 'Pay securely via International payment methods.', 'uddoktapay-gateway' );
	}
	...
	protected function get_enable_label() {
		return __( 'Enable UddoktaPay International Payment', 'uddoktapay-gateway' );
	}
